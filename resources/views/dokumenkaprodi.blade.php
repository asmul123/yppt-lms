...
<div class="main-content container-fluid">
    <div class="page-title">
        <h3>Daftar Dokumen Administrasi Kaprodi</h3>
    </div>
                    ...
                    <div class="modal fade text-left modal-borderless" id="tambah-dokumen" tabindex="-1" role="dialog" aria-labelledby="modalTambah" aria-hidden="true">
                        <div class="modal-dialog modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ url('/dokumenkaprodi') }}" method="post">
                                    @csrf
                  ...
                  <table class="table table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $dokumenkaprodi->tahunpelajaran->tahunpelajaran }}</td>
                            <td>{{ $dokumenkaprodi->juduldokumen }}</td>
                            <td>{{ $dokumenkaprodi->jenisdokumen }}</td>
                            <td>{{ $dokumenkaprodi->ukurandokumen }}</td>
                            <td>
                                <div class="btn-group mb-3" role="group" aria-label="Basic example">
                                    <a href="{{ url('/') }}/dokumenkaprodi/{{ $dokumenkaprodi->id }}/edit" class="badge bg-warning"><i data-feather="edit"></i></a>
